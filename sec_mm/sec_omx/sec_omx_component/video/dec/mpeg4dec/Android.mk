...
LOCAL_MODULE := libOMX.SEC.M4V.Decoder.smdkv310

LOCAL_CFLAGS :=

LOCAL_ARM_MODE := arm

LOCAL_STATIC_LIBRARIES := libSEC_OMX_Vdec.smdkv310 libsecosal.smdkv310 libsecbasecomponent.smdkv310 libsecmfcdecapi.smdkv310
