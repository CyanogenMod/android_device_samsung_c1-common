...
LOCAL_MODULE := libOMX.SEC.AVC.Decoder.smdkc210

LOCAL_CFLAGS :=

LOCAL_ARM_MODE := arm

LOCAL_STATIC_LIBRARIES := libSEC_OMX_Vdec.smdkc210 libsecosal.smdkc210 libsecbasecomponent.smdkc210 libsecmfcdecapi.smdkc210
