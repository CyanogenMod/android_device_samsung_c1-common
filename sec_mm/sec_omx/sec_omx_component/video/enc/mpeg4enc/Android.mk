...
LOCAL_MODULE := libOMX.SEC.M4V.Encoder.smdkv310

LOCAL_CFLAGS :=

LOCAL_ARM_MODE := arm

LOCAL_STATIC_LIBRARIES := libSEC_OMX_Venc.smdkv310 libsecosal.smdkv310 libsecbasecomponent.smdkv310 libsecmfcencapi.smdkv310
